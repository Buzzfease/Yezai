...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    private boolean isNeedChangeTextSize = false;
    ...
    private int tabTextColor = -0x99999a;
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        selectedTabTextColor=a.getColor(R.styleable.AdvancedPagerSlidingTabStrip_apTabTextSelectColor, indicatorColor);
    ...
    public void setNeedChangeTextSize(Boolean need){
        this.isNeedChangeTextSize = need;
    }
