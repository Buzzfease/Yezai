...
public class UnderLineTextView extends AppCompatTextView {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        //获取自定义属性
        TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.UnderLineTextView, defStyleAttr, 0);
        mColor = array.getColor(R.styleable.UnderLineTextView_underlineColor, 0xFFFF0000);
        mStrokeWidth = array.getDimension(R.styleable.UnderLineTextView_underlineWidth, density * 2);
        array.recycle();
